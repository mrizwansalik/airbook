...
class AdvertisementsSerializer(serializers.ModelSerializer):
    ...
    dimensions = {
        "page-top":{"height":80, "width":1170},
        "page-bottom":{"height":80, "width":860},
    ...
    class Meta:
        ...
        fields = ('id','user','start_date','remove_file','end_date','section','file','is_active','created_at','updated_at')
