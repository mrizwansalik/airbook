...
class AircraftsSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        send_emails(subject, html_content, [abaircraft.user.email])
    ...
    def update(self, instance, validated_data):
        ...
        if 'msn' in validated_data:            
            if isRoleUser(user) and (~Q(instance.msn == validated_data['msn'])) :
...
class EnginesSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        send_emails(subject, html_content, [abengine.user.email])
...
class ApusSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        send_emails(subject, html_content, [apus.user.email])
...
class PartsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        datatables_always_serialize = ('id','leads','condition')
