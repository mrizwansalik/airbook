                    ...
                    <div className="details-data-block">
                      ...
                      {checkValue(
                        ...
                        <div className="data-block">
                          ...
                          <p className="data-value">{"$" + aircraft.price}</p>
                        </div>
                      ) : (
                        ""
                      )}
                      ...
                      {checkValue(aircraft.manager && aircraft.owner.name) ? (
                        <div className="data-block">
                      ...
                      {checkValue(aircraft.manager && aircraft.manager.name) ? (
                        <div className="data-block">
                          <div className="data-label">Seller</div>
                          <p className="data-value">
                            {aircraft.seller && aircraft.seller.name}
                          </p>
                        </div>
                      ) : (
                        ""
                  ...
                  <div className="flex-col-right">
                    ...
                    <div className="sidebar-data-wrapper">
                      ...
                      <div className="share-flex">
                        ...
                        <a
                          href={`https://api.whatsapp.com/send?phone=whatsappphonenumber&text=${process.env.NEXT_PUBLIC_API_URL}aircraft/${this.props.params.detail}`}
                          target="_blank"
                          className="share-widget w-inline-block"
                        >
                          <div className="w-embed">
