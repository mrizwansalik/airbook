...
import { showFilters, next_link, previous_link, getData, ucwords, likes, randomizeOrdering, checkValue } from '../../../helpers/functions';
                ...
                <div className="ap-cont-txt-block">
                  <div className="w-layout-grid ap-field-grid">
                    <div className="airport-update-block">
                      <label htmlFor="Airport-Name" className="txt-label">Airport *</label>
                      <input
                        type="text"
                    ...
                    <div className="airport-update-block">
                      <label htmlFor="Airfield-Type" className="txt-label">Airfield Type *</label>
                      <input
                        type="text"
                        className="apfield w-input"
                        maxLength={256}
                    ...
                    <div className="airport-update-block">
                      <label htmlFor="ICAO" className="txt-label">ICAO</label>
                      <input
                        type="text"
                        maxLength={256}
                        name="icao"
                    ...
                    <div className="airport-update-block">
                      <label htmlFor="IATA" className="txt-label">IATA</label>
                      <input
                        type="text"
                        maxLength={256}
                        name="iata"
                    ...
                    <div className="airport-update-block">
                      <label htmlFor="Country" className="txt-label">Country</label>
                      <input
                        type="text"
                        maxLength={256}
                        name="country"
                    ...
                    <div className="airport-update-block">
                      <label htmlFor="Longitude" className="txt-label">Longitude</label>
                      <input
                        type="text"
                        maxLength={256}
                        name="longitude"
                    ...
                    <div className="airport-update-block">
                      <label htmlFor="Latitude" className="txt-label">Latitude</label>
                      <input
                        type="text"
                        maxLength={256}
                        name="latitude"
                    ...
                    <div className="airport-update-block">
                      <label htmlFor="Timezone" className="txt-label">Timezone</label>
                      <input
                        type="text"
                        maxLength={256}
                        name="timezone"
            ...
            <div className="ab-page-main-content">
              ...
              <div className="list-block">
                ...
                <div className="list-pagniation">
                  {previous &&
                    <Link href={`/airport/p/[list]?filters=${JSON.stringify(this.state.selected_filters)}&search=${search_str}`} as={`/airport/p/${previous}`}>
                      <a className="pagination-button w-button">Previous</a>
                    </Link>}
                  {next &&
                    <Link href={`/airport/p/[list]?filters=${JSON.stringify(this.state.selected_filters)}&search=${search_str}`} as={`/airport/p/${next}`}>
                      <a className="pagination-button w-button">Next</a>
                    </Link>}
                </div>
                {airports.length === 0 && <div className="list-empty">
