...
import { formatDate, checkValue, getData, randomizeOrdering } from '../../helpers/functions';
              ...
              <div className="flex-col-right">
                ...
                <div className="sidebar-data-wrapper">
                  ...
                  <div className="share-flex">
                    ...
                    <a href={`https://api.whatsapp.com/send?phone=whatsappphonenumber&text=${process.env.NEXT_PUBLIC_API_URL}airport/${this.props.params.detail}`} target="_blank" className="share-widget w-inline-block">
                      <div className="w-embed">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width={24}
