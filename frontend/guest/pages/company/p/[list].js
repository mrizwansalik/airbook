            ...
            <div className="ab-page-main-content">
              ...
              <div className="list-block">
                <div className="ab-page-title-block">
                  ...
                  <p className="ab-page-description"> {selected_specialites +"and more"}
                  </p>
                </div>
                  ...
                  {companies && companies.map((company, index) => {
                    return <div className="ab-list-item-wrapper company" key={index}>
                          ...
                          <div className="item-h3-block">
                            {
                              company.specialities.map((specialty, index)=>{
                                return <h3 className="subtitle" key={index}>{specialty.name} </h3>
                              })
                            }
                          </div>
                        </div>
                      ...
                      <div className="item-data-flex">
                        ...
                        <Link href={{ pathname: `/company/[detail]` }} as={`/company/${company && (company.id + "-" + company.name.split('/').join('-'))}`}>
                          <a className="item-image w-inline-block" style={{backgroundImage: `url(${getMediaUrl(company.media)})`}}>
                          </a>
                        </Link> : ''}
                        ...
                        {company.contacts > 0 ? 
                          <div className="flex-specsbox">
                            ...
                            <p className="item-specs"> {company.contacts === 1 ? company.contacts+' Contact':company.contacts+' Contacts'} on airbook</p>
                          </div>: ''}
                          {company.address ? 
                          <div className="flex-specsbox">
                ...
                <div className="list-pagniation">
                  {previous &&
                    <Link href={`/company/p/[list]?filters=${JSON.stringify(this.state.selected_filters)}&search=${search_str}`} as={`/company/p/${previous}`}>
                      <a className="pagination-button w-button">Previous</a>
                    </Link>}
                  {next &&
                    <Link href={`/company/p/[list]?filters=${JSON.stringify(this.state.selected_filters)}&search=${search_str}`} as={`/company/p/${next}`}>
                      <a className="pagination-button w-button">Next</a>
                    </Link>}
                </div>
                {companies.length === 0 && <div className="list-empty">
