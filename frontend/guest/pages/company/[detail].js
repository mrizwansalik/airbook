        ...
        <div className="ab-page-content">
          <div className="ab-container w-container">
            ...
            {topAdvert && topAdvert.media != null ? <a href="#" target="_blank" className="ab-top-page-advert w-inline-block" style={{ backgroundImage: 'url(/static/images/' + topAdvert.media.original_file_name + ')' }}></a>
              : ""}
            <h1 className="details-page-headline">{checkValue(company.name)}</h1>
            <div className="publish-date-block">
              ...
              <div className="date-created-updated">
                {"Published " + formatDate(company.created_at) + " - Updated " + formatDate(company.updated_at)}
              </div>
            </div>
            <div className="breadcrumb-block">
              ...
              <div className="current-asset">{checkValue(company.name)}</div>
            </div>
              ...
              <div className="flex-col-left">
                <div className="details-data-block">
                  <div className="label-block">
                    ...
                    <h3 className="details-block-headline">Company Profile</h3>
                  </div>
                  ...
                  {checkValue(company.specialities.length > 0) && (company.specialities.map((speciality) => {
                        return speciality.name + ", ";
                      }) || "N/A")?
                  <div className="data-block">
                    <div className="data-label">Specialty</div>
                    <p className="data-value">{
                      (company.specialities.length > 0) && (company.specialities.map((speciality) => {
                        return speciality.name + ", ";
                      }) || "N/A")}</p>
                  </div>:''
                    }
                  ...
                  <div className="data-block">
                    ...
                    <p className="data-value">{company.country && company.country.name}</p>
                  </div>:''
                  }
                ...
                <div className="details-data-block">
                  <div className="label-block">
                    ...
                    <h3 className="details-block-headline">{`About ${checkValue(company.name)}`}</h3>
                  </div>
                   
                  <div className="data-block file-attachment">
                    <p className="data-value" dangerouslySetInnerHTML={{__html:company.profile}}></p>
                  </div>
                </div>: ""}
                <div className="details-data-block">
                  <div className="label-block">
                    ...
                    <h3 className="details-block-headline">People on {checkValue(company.name)}</h3>
                  </div>
                    ...
                    return <div className="data-block file-attachment" key={index}>
                      <Link href={{ pathname: `/contact/[detail]` }} as={`/contact/${contact.id + '-' + contact.first_name + "-" + contact.last_name}`}>
                        <a target="_blank" className="on-airbook-link">
                          {checkValue(contact.first_name)}{" "}{checkValue(contact.last_name)}
                        </a>
                      </Link>
                      <div className="job-title-company-profile">{checkValue(contact.job_title && contact.job_title.name)}</div>
                    </div>
                  })}
                </div>
                <div className="details-data-block">
                  <div className="label-block">
                    ...
                    <h3 className="details-block-headline">Assets on {checkValue(company.name)}</h3>
                  </div>
                  <div className="data-block file-attachment">
                    <a href="#" target="_blank" className="on-airbook-link">
                      Boeing 737-300 for ACMI
                    </a>
                    <div className="asset-type-company-profile">Aircraft</div>
                  </div>
                  <div className="data-block file-attachment">
                    <a href="#" target="_blank" className="on-airbook-link">
                      CFM 56-3C1 available for Sale
                    </a>
                    <div className="asset-type-company-profile">Engines</div>
                  </div>
                  <div className="data-block file-attachment">
                    <a href="#" target="_blank" className="on-airbook-link">
                      P&amp;W available for sale
                    </a>
                  ...
                  <div className="data-block file-attachment">
                    ...
                    <div className="asset-type-company-profile">Wanted</div>
                  </div>
                </div>
                <div className="related-items-block">
                  ...
                  {related.length > 0 ? related.map((company, index) => {
                        ...
                        <div className="ab-list-item-wrapper company">
                          <div className="item-flex-header">
                            <div className="item-title-block">
                              <Link href={{ pathname: `/company/detail` }} as={`/company/${company.id && company.id + "-" + company.name}`}>
                                <a className="item-link-block w-inline-block">
                                  <h2 className="item-composite-title">{company.name}</h2>
                                </a>
                              </Link>
                          ...
                          <div className="item-data-flex">
                            ...
                            {checkValue(company.contacts)?
                              <div className="flex-specsbox">
                                ...
                                <p className="item-specs">{`${company.contacts ? company.contacts : 'No'}${company.contacts === 1 ? " Contact" : " Contacts"}`}</p> 

                                </div>: ''}
                              {checkValue(company.address)?
                              <div className="flex-specsbox">
                                {checkValue(company.country && company.country.flag)?  <div className="svg-flag" style={{backgroundImage:`url(/static/media/site/flags/${company.country.flag})`}}/>: ''}
                                <div className="country-name">{company.address ? company.address : 'Address not Provided'}</div>
                              </div>:''
                              }
                            </div>
                          </div>
                  ...
                  <div className="list-empty mb-10">
                    ...
                    <div className="no-results-message">No related company.</div>
                  </div>}
                </div>
              </div>
              ...
              {company.media && company.media.exist ?
                    ...
                    <style jsx>
                      {
                        `.profile-image.company-brand{
														background-image: url(${process.env.NEXT_PUBLIC_API_URL}static/media/uploads/${company.media ? company.media.original_file_name : "placeholder.png"})};
												}`
                      }
                    </style>
                ...
                <div className="sidebar-data-wrapper">
                  ...
                  <div className="sidebar-data-block">
                    ...
                    {isAuthenticate ? 
                    <a href="tel: + {company.business_phone} "  className="profile-link">
                  ...
                  <div className="sidebar-data-block">
                    ...
                    >
                      {company.website}
                    </a>: <div className="locked-item-block">
                     <div className="ab-svg-icon new-lock w-embed">
                       <svg
                         xmlns="http://www.w3.org/2000/svg"
                         width={12}
                ...
                <div className="sidebar-data-wrapper">
                  <div className="label-block">
                    ...
                    <h3 className="details-block-headline">{`Message ${company.name}`}</h3>:<h3 className="details-block-headline">Message To Publisher</h3> }
                  </div>
                ...
                <div className="sidebar-data-wrapper">
                  ...
                  <div className="share-flex">
                    <a href={`https://www.linkedin.com/shareArticle?mini=true&url=${process.env.NEXT_PUBLIC_API_URL}company/${this.props.params.detail}`} target="_blank" className="share-widget w-inline-block">
                    ...
                    <a href={`https://www.facebook.com/sharer/sharer.php?u=${process.env.NEXT_PUBLIC_API_URL}company/${this.props.params.detail}`} target="_blank" className="share-widget w-inline-block">
                      <div className="w-embed">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width={24}
                    ...
                    <a href={`https://api.whatsapp.com/send?phone=whatsappphonenumber&text=${process.env.NEXT_PUBLIC_API_URL}company/${this.props.params.detail}`} target="_blank" className="share-widget w-inline-block">
                      <div className="w-embed">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width={24}
