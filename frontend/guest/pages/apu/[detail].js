...
import { formatDate, checkValue, getData, likes, graphValues, getTitle, getMediaUrl } from '../../helpers/functions';
              ...
              {apu.media.length > 0 ?
                ...
                <div className="details-data-block">
                  ...
                  <div className="data-block">
                    ...
                    <p className="data-value">{ "$" + apu.price}</p>
                  </div>:''
                  }
                  ...
                  <div className="data-block">
                    ...
                    <p className="data-value">{apu.availability, 'availability'}</p>
                  </div> : '' }
                        ...
                        <div className="item-flex-header">
                          <div className="item-title-block">
                            ...
                            <div className="item-h3-block">
                              ...
                              {apu.price !== null && apu.price >=1 ? <div className="sidebar-price">{"$" + apu.price}</div> : ''}
                            </div>
                          </div>
              ...
              <div className="flex-col-right">
                <div className="sidebar-data-wrapper">
                  ...
                  <div className="sidebar-data-block">
                    ...
                    <div className="offered-for-value">
                      <p className="data-value">{apu.offer_for}</p>
                      {checkValue(apu.price !==null && apu.price >=1)?  <div className="sidebar-price">{"$" + apu.price}</div>:''}
                    </div>
                  </div>: ''}
                ...
                <div className="sidebar-data-wrapper">
                  ...
                  <div className="share-flex">
                    ...
                    <a href={`https://api.whatsapp.com/send?phone=whatsappphonenumber&text=${process.env.NEXT_PUBLIC_API_URL}apu/${this.props.params.detail}`} target="_blank" className="share-widget w-inline-block">
                      <div className="w-embed">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width={24}
