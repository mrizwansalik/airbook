            ...
            <div className="ab-page-main-content">
              ...
              <div className="list-block">
                ...
                <div className="list-pagniation" data={search_str}>
                  {previous &&
                    <Link href={`/apu/p/[list]?filters=${JSON.stringify(this.state.selected_filters)}&search=${search_str}`} as={`/apu/p/${previous}`}>
                      <a className="pagination-button w-button">Previous</a>
                    </Link>}
                  {next &&
                    <Link href={`/apu/p/[list]?filters=${JSON.stringify(this.state.selected_filters)}&search=${search_str}`} as={`/apu/p/${next}`}>
                      <a className="pagination-button w-button">Next</a>
                    </Link>}


                </div>
                {apus.length === 0 && <div className="list-empty">
