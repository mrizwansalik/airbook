...
import { showFilters, next_link, previous_link, getData, likes, ucwords, availFor, randomizeOrdering, getTitle } from '../../../helpers/functions';
        ...
        <div className="ab-page-content">
          <div className="ab-container w-container">
            ...
            <div className="ab-page-main-content">
              ...
              { availFor(this, 'wanted') !== '' && <div className="ab-page-title-block">
                  <h1 className="page-title">Wanted assets</h1>
                  <p className="ab-page-description">{" for " + availFor(this, 'wanted')}</p>
                </div> }
                        ...
                        <div className="item-info-block">
                          <div className="flex-specsbox">
                            <p className="item-specs">
                              {wanted.yom ? <span className="spec-span wanted-specs">{"YOM " + wanted.yom}</span>:''}
                              {wanted.terms ? <span className="spec-span dot-before">{wanted.terms}</span>:''}
                            </p>
                          </div>
                          {wanted.primary_contact && wanted.primary_contact.company && wanted.primary_contact.company.country && wanted.primary_contact.company.country.name ?
                          <div className="flex-specsbox">
                        ...
                        <div className="ab-list-item-widget">
                          <div data-delay={0} className="ab-list-item-menu w-dropdown">
                            ...
                            <nav className={`ab-list-item-dropdown w-dropdown-list ${ids.includes(index) && 'w--open'}`}>
                              ...
                              {wanted.favourite !== true && <a href="#" className="list-item-menu-link w-dropdown-link" onClick={()=>{this.addFavorite(wanted.id, 'App\\Wanted')}}>
                                Add to favorite
                              </a>}
                              <Link href={{ pathname: `/wanted/[detail]` }} as={`/wanted/${wanted.id && (wanted.id + "-" + (wanted.title.split('/').join('-')))}`}>
                ...
                <div className="list-pagniation">
                  {previous &&
                    <Link href={`/wanted/p/[list]?filters=${JSON.stringify(this.state.selected_filters)}&search=${search_str}`} as={`/wanted/p/${previous}`}>
                      <a className="pagination-button w-button">Previous</a>
                    </Link>}
                  {next &&
                    <Link href={`/wanted/p/[list]?filters=${JSON.stringify(this.state.selected_filters)}&search=${search_str}`} as={`/wanted/p/${next}`}>
                      <a className="pagination-button w-button">Next</a>
                    </Link>}
                </div>
                {wanteds.length === 0 && <div className="list-empty">
