                  ...
                  engine.media.map((media, index) => {
                    return (
                      <figure key={index} className="w-lightbox-figure">
                        <img className="w-lightbox-group w-lightbox-image imageHeight" 
                    ...
                    <div className="details-data-block">
                      ...
                      {checkValue(engine.price) && engine.price >= 1 ? (
                        <div className="data-block">
                          ...
                          <p className="data-value">{"$" + engine.price}</p>
                        </div>
                      ) : (
                        ""
                      )}
                  ...
                  <div className="flex-col-right">
                    ...
                    <div className="sidebar-data-wrapper">
                      <div className="label-block">
                        ...
                        </h3>:<h3 className="details-block-headline">Message To Publisher</h3> }
                      </div>
                    ...
                    <div className="sidebar-data-wrapper">
                      ...
                      <div className="share-flex">
                        ...
                        <a
                          href={`https://api.whatsapp.com/send?phone=whatsappphonenumber&text=${process.env.NEXT_PUBLIC_API_URL}engine/${this.props.params.detail}`}
                          target="_blank"
                          className="share-widget w-inline-block"
                        >
                          <div className="w-embed">
                    ...
                    {checkValue(promoted.length > 0) ? (
                      <div className="sidebar-promoted-block">
                        ...
                        {sideAdvert && sideAdvert.media != null ? (
                          <a
                            href="#"
                            target="_blank"
