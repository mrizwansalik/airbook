...
import { showFilters, next_link, previous_link, getData, likes, ucwords, availFor, getMediaUrl, randomizeOrdering, getTitle, checkValue } from '../../../helpers/functions';
            ...
            <div className="ab-page-main-content">
              ...
              { availFor(this) !== '' && <div className="ab-page-title-block">
                        ...
                        <div className="item-flex-header">
                          ...
                          <div className="item-like-block">
                            <div
                              ...
                              onClick={() => this.getlikes(engine.id, "Engine")}
                            >
                              <svg
                            ...
                            >
                              ...
                              >
                                ...
                                <Link
                                  href={{ pathname: `/engine/detail` }}
                                  as={`/engine/${
                                    engine.id && engine.id + "-" + engine.title
                                  }`}
                                >
                ...
                <div className="list-pagniation">
                  {previous &&
                    <Link href={`/engine/p/[list]?filters=${JSON.stringify(this.state.selected_filters)}&search=${search_str}`} as={`/engine/p/${previous}`}>
                      <a className="pagination-button w-button">Previous</a>
                    </Link>}
                  {next &&
                    <Link href={`/engine/p/[list]?filters=${JSON.stringify(this.state.selected_filters)}&search=${search_str}`} as={`/engine/p/${next}`}>
                      <a className="pagination-button w-button">Next</a>
                    </Link>}
                </div>
                {engines.length === 0 && <div className="list-empty">
